...
var Auth = function () {
  function Auth(config) {
    ...
    (0, _configurationValidation.assertIssuer)(config.issuer, testing);
    (0, _configurationValidation.assertClientId)(config.client_id);
    (0, _configurationValidation.assertRedirectUri)(config.redirect_uri);
    this._oktaAuth = new _oktaAuthJs2.default((0, _configurationValidation.buildConfigObject)(config));
  ...
  (0, _createClass3.default)(Auth, [{
    ...
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8() {
        ...
        var responseType, scopes;
        return _regenerator2.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                responseType = additionalParams.response_type || this._config.response_type || ['id_token', 'token'];
                scopes = additionalParams.scope || this._config.scope || ['openid', 'email', 'profile'];


                this._oktaAuth.token.getWithRedirect((0, _extends3.default)({
